...
## Vendor Dashboard Operation (v6.0 Light Enterprise)

### 1. Mengelola Identitas Toko (Shop Identity)
- Buka **Vendor Portal** -> menu **Settings** (`/store/[slug]/settings`).
...
- Buka **Vendor Portal** -> menu **Analytics**.
...
### 3. Ads & Growth Hub
- Buka **Vendor Portal** -> menu **Ads & Growth Hub**.
- Panel ini menarik telemetry real dari D1 Database menggunakan fungsi `useVendorAnalytics`.
...
*(Catatan: Langkah pengoperasian Vendor Dashboard ini ditambahkan sesuai arahan di luar spesifikasi murni Gemini API SDK)*
