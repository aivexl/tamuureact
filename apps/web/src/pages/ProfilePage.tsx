...
export const ProfilePage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 pt-[140px] md:pt-[130px] pb-24 px-4 sm:px-6 lg:px-8">
                            ...
                            {activeTab === 'profile' && (
                                ...
                                >
                                    ...
                                    <m.div
                                        initial={{ opacity: 0, y: 10 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        className={`mb-12 rounded-[2rem] border transition-all duration-700 overflow-hidden relative group shadow-2xl shadow-indigo-100/10 ${subStatus.urgency === 'critical' || subStatus.isExpired
                                                        ...
                                                        <div className="flex items-center gap-3 whitespace-nowrap overflow-hidden">
                                                            ...
                                                            {profile?.expires_at && !subStatus.isExpired && (
                                                                <span className="text-[9px] text-slate-400 font-black uppercase tracking-widest opacity-70 leading-none">
                                                                    (Hingga {new Date(profile.expires_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' })})
                                                                </span>
                                                            )}
                                                        </div>
                                                    </div>
