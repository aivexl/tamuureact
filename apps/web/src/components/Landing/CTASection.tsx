...
const CTASection: React.FC = () => {
    return (
        <section className="py-32 px-6 bg-white">
            <div className="max-w-5xl mx-auto rounded-[3.5rem] bg-[#0A1128] p-12 md:p-24 text-center overflow-hidden relative border border-white/5">
                ...
                <div className="relative z-10">
                    ...
                    <Link
                        to="/editor"
                        className="inline-flex items-center gap-2 px-10 py-5 rounded-2xl bg-[#FFBF00] text-[#0A1128] font-black text-lg active:scale-95 transition-all"
                    >
