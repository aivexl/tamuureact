...
import { Heart, Plus, Trash2, Calendar, Type, ChevronDown, Palette, Lock } from 'lucide-react';
...
export const LoveStoryCard: React.FC<ElementCardProps> = ({ element, handleUpdate, permissions }) => {
    ...
    const canEditContent = permissions.canEditContent || permissions.canEditText;
        ...
        <div className="space-y-5">
            <div className="flex items-center justify-between px-1">
                ...
                {canEditContent ? (
                    ...
                    <div className="flex items-center gap-1 text-slate-300 text-[9px] font-bold uppercase tracking-widest">
                    ...
                    <div key={ev.id} className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-3 relative group/event">
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-700 outline-none focus:ring-2 focus:ring-pink-500/10 focus:border-pink-500 disabled:opacity-60 disabled:bg-slate-100/50"
                                    placeholder="2024"
                                />
                            </div>
                            <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                disabled={!canEditContent}
                                className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-xs font-medium text-slate-600 outline-none focus:ring-2 focus:ring-pink-500/10 focus:border-pink-500 min-h-[60px] resize-none disabled:opacity-60 disabled:bg-slate-100/50"
