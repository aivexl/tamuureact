...
const PromoBanner = () => (
    <div className="my-16 p-6 sm:p-8 rounded-3xl bg-white border border-slate-100 flex flex-col md:flex-row items-center gap-6 sm:gap-8 shadow-xl">
        ...
        <Link to="/pricing" className="w-full md:w-auto text-center px-8 py-3.5 bg-[#0A1128] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-slate-800 transition-all">Lihat Paket</Link>
    </div>
);
...
export const BlogPostLayout: React.FC<BlogPostLayoutProps> = ({ post, relatedPosts }) => {
    ...
    // BlogPosting Schema (Enterprise SEO)
