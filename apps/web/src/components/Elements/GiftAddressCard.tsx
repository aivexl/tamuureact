...
export const GiftAddressCard: React.FC<GiftAddressCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 h-full w-full p-[6%] flex flex-col justify-start gap-[6%]">
                {/* HEADER */}
                ...
                <div className="w-full flex flex-col items-start gap-0">
                    ...
                    <button
                        ...
                        className={`w-full group flex flex-col items-start outline-none transition-transform active:scale-[0.98] mt-[5%] ${isPreview ? 'cursor-default' : 'cursor-pointer'}`}
                    >
