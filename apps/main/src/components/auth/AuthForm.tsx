        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode === 'login' && (
                <div className="flex justify-end px-2">
                    <Link href="/forgot-password" title="Forgot Password" className="text-xs font-bold text-premium-accent hover:text-premium-accent-light transition-colors uppercase tracking-widest cursor-pointer">
                        Lupa Password?
                    </Link>
                </div>
            )}
