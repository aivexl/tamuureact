            ...
            <section id="features" className="max-w-7xl mx-auto px-6 py-24 bg-white">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="feature-card group p-10 bg-[#F8FAFC] rounded-[2.5rem] border border-slate-200/50 shadow-md hover:shadow-2xl hover:shadow-[#0A1128]/10 transition-all duration-500"
                        >
