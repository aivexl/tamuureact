...
export const ProductDetailClient: React.FC = () => {
    ...
    const handleChat = () => {
        ...
        router.push(`/dashboard?tab=messages&vendorId=${product.vendor_id}`);
    };
                            ...
                            <div className="p-6 md:p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                                ...
                                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                                    <div className="w-16 h-16 rounded-2xl overflow-hidden bg-white border-4 border-white shadow-lg flex-shrink-0">
                                        <img 
                                            src={product.logo_url || `https://api.dicebear.com/7.x/initials/svg?seed=${product.nama_toko || product.custom_store_name || ''}`} 
                        ...
                        <div className="lg:col-span-12 flex flex-col h-full gap-8">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                                    {/* Row 1: Marketplace (Full Width Reference) */}
                                    <VendorContactItem 
                                        id="shopee" 
                                        label="Shopee" 
